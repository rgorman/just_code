...
* This code block supplies the values for the new variables created by combination. The essence of the code block is a nested loop. The outter loop iterates through each element in **culled.output.list.**  Each of those elements contains a matrix with columns constituting combinations of attribute names. 
